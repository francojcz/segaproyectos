...
abstract class BaseEventoEnRegistroPeer {
	...
	/**
	 * Returns the number of rows matching criteria, joining the related RegistroUsoMaquina table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinRegistroUsoMaquina(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EventoEnRegistroPeer::EVRG_RUM_CODIGO, RegistroUsoMaquinaPeer::RUM_CODIGO, $join_behavior);
	...
	public static function doCountJoinEvento(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EventoEnRegistroPeer::EVRG_EVE_CODIGO, EventoPeer::EVE_CODIGO, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related UsuarioRelatedByEvrgUsuCrea table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinUsuarioRelatedByEvrgUsuCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(EventoEnRegistroPeer::EVRG_USU_CREA, UsuarioPeer::USU_CODIGO, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related UsuarioRelatedByEvrgUsuActualiza table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinUsuarioRelatedByEvrgUsuActualiza(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(EventoEnRegistroPeer::EVRG_USU_ACTUALIZA, UsuarioPeer::USU_CODIGO, $join_behavior);
	...
	/**
	 * Selects a collection of EventoEnRegistro objects pre-filled with their RegistroUsoMaquina objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of EventoEnRegistro objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinRegistroUsoMaquina(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		EventoEnRegistroPeer::addSelectColumns($criteria);
		$startcol = (EventoEnRegistroPeer::NUM_COLUMNS - EventoEnRegistroPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = EventoEnRegistroPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = EventoEnRegistroPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				EventoEnRegistroPeer::addInstanceToPool($obj1, $key1);
			} // if $obj1 already loaded

			$key2 = RegistroUsoMaquinaPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = RegistroUsoMaquinaPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					...
					RegistroUsoMaquinaPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
				
				// Add the $obj1 (EventoEnRegistro) to $obj2 (RegistroUsoMaquina)
				$obj2->addEventoEnRegistro($obj1);
	...
	/**
	 * Selects a collection of EventoEnRegistro objects pre-filled with their Evento objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of EventoEnRegistro objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinEvento(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (EventoEnRegistro) to $obj2 (Evento)
				$obj2->addEventoEnRegistro($obj1);
	...
	/**
	 * Selects a collection of EventoEnRegistro objects pre-filled with their Usuario objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of EventoEnRegistro objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUsuarioRelatedByEvrgUsuCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (EventoEnRegistro) to $obj2 (Usuario)
				$obj2->addEventoEnRegistroRelatedByEvrgUsuCrea($obj1);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUsuarioRelatedByEvrgUsuActualiza(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (EventoEnRegistro) to $obj2 (Usuario)
				$obj2->addEventoEnRegistroRelatedByEvrgUsuActualiza($obj1);
	...
	/**
	 * Selects a collection of EventoEnRegistro objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		EventoEnRegistroPeer::addSelectColumns($criteria);
		$startcol2 = (EventoEnRegistroPeer::NUM_COLUMNS - EventoEnRegistroPeer::NUM_LAZY_LOAD_COLUMNS);

		RegistroUsoMaquinaPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (RegistroUsoMaquinaPeer::NUM_COLUMNS - RegistroUsoMaquinaPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined RegistroUsoMaquina rows

			$key2 = RegistroUsoMaquinaPeer::getPrimaryKeyHashFromRow($row, $startcol2);
			if ($key2 !== null) {
				$obj2 = RegistroUsoMaquinaPeer::getInstanceFromPool($key2);
				if (!$obj2) {
				...
				// Add the $obj1 (EventoEnRegistro) to the collection in $obj2 (RegistroUsoMaquina)
				$obj2->addEventoEnRegistro($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (EventoEnRegistro) to the collection in $obj3 (Evento)
				$obj3->addEventoEnRegistro($obj1);
			} // if joined row not null
			...
			if ($key4 !== null) {
				...
				// Add the $obj1 (EventoEnRegistro) to the collection in $obj4 (Usuario)
				$obj4->addEventoEnRegistroRelatedByEvrgUsuCrea($obj1);
			} // if joined row not null
			...
			if ($key5 !== null) {
				...
				// Add the $obj1 (EventoEnRegistro) to the collection in $obj5 (Usuario)
				$obj5->addEventoEnRegistroRelatedByEvrgUsuActualiza($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptRegistroUsoMaquina(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptUsuarioRelatedByEvrgUsuCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptUsuarioRelatedByEvrgUsuActualiza(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of EventoEnRegistro objects pre-filled with all related objects except RegistroUsoMaquina.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptRegistroUsoMaquina(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = EventoEnRegistroPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (EventoEnRegistro) to the collection in $obj2 (Evento)
				$obj2->addEventoEnRegistro($obj1);
				...
				// Add the $obj1 (EventoEnRegistro) to the collection in $obj3 (Usuario)
				$obj3->addEventoEnRegistroRelatedByEvrgUsuCrea($obj1);
				...
				// Add the $obj1 (EventoEnRegistro) to the collection in $obj4 (Usuario)
				$obj4->addEventoEnRegistroRelatedByEvrgUsuActualiza($obj1);
	...
	/**
	 * Selects a collection of EventoEnRegistro objects pre-filled with all related objects except Evento.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptEvento(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of EventoEnRegistro objects pre-filled with all related objects except UsuarioRelatedByEvrgUsuCrea.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUsuarioRelatedByEvrgUsuCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of EventoEnRegistro objects pre-filled with all related objects except UsuarioRelatedByEvrgUsuActualiza.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUsuarioRelatedByEvrgUsuActualiza(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
