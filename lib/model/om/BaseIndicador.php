...
abstract class BaseIndicador extends BaseObject  implements Persistent {
	 ...
	 * @var        Usuario
	 */
	protected $aUsuarioRelatedByIndUsuCrea;

	/**
	 * @var        Usuario
	 */
	protected $aUsuarioRelatedByIndUsuActualiza;
	...
	public function setIndUsuCrea($v)
	{
		...
		if ($this->aUsuarioRelatedByIndUsuCrea !== null && $this->aUsuarioRelatedByIndUsuCrea->getUsuCodigo() !== $v) {
			$this->aUsuarioRelatedByIndUsuCrea = null;
		}
	...
	public function setIndUsuActualiza($v)
	{
		...
		if ($this->aUsuarioRelatedByIndUsuActualiza !== null && $this->aUsuarioRelatedByIndUsuActualiza->getUsuCodigo() !== $v) {
			$this->aUsuarioRelatedByIndUsuActualiza = null;
		}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aUsuarioRelatedByIndUsuCrea !== null && $this->ind_usu_crea !== $this->aUsuarioRelatedByIndUsuCrea->getUsuCodigo()) {
			$this->aUsuarioRelatedByIndUsuCrea = null;
		}
		if ($this->aUsuarioRelatedByIndUsuActualiza !== null && $this->ind_usu_actualiza !== $this->aUsuarioRelatedByIndUsuActualiza->getUsuCodigo()) {
			$this->aUsuarioRelatedByIndUsuActualiza = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aUsuarioRelatedByIndUsuCrea !== null) {
				if ($this->aUsuarioRelatedByIndUsuCrea->isModified() || $this->aUsuarioRelatedByIndUsuCrea->isNew()) {
					$affectedRows += $this->aUsuarioRelatedByIndUsuCrea->save($con);
				}
				$this->setUsuarioRelatedByIndUsuCrea($this->aUsuarioRelatedByIndUsuCrea);
			}

			if ($this->aUsuarioRelatedByIndUsuActualiza !== null) {
				if ($this->aUsuarioRelatedByIndUsuActualiza->isModified() || $this->aUsuarioRelatedByIndUsuActualiza->isNew()) {
					$affectedRows += $this->aUsuarioRelatedByIndUsuActualiza->save($con);
				}
				$this->setUsuarioRelatedByIndUsuActualiza($this->aUsuarioRelatedByIndUsuActualiza);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aUsuarioRelatedByIndUsuCrea !== null) {
				if (!$this->aUsuarioRelatedByIndUsuCrea->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsuarioRelatedByIndUsuCrea->getValidationFailures());
				}
			}

			if ($this->aUsuarioRelatedByIndUsuActualiza !== null) {
				if (!$this->aUsuarioRelatedByIndUsuActualiza->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsuarioRelatedByIndUsuActualiza->getValidationFailures());
				}
			}
	 ...
	 * @throws     PropelException
	 */
	public function setUsuarioRelatedByIndUsuCrea(Usuario $v = null)
	{
		if ($v === null) {
			$this->setIndUsuCrea(NULL);
		} else {
			$this->setIndUsuCrea($v->getUsuCodigo());
		}

		$this->aUsuarioRelatedByIndUsuCrea = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Usuario object, it will not be re-added.
		if ($v !== null) {
			$v->addIndicadorRelatedByIndUsuCrea($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getUsuarioRelatedByIndUsuCrea(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByIndUsuCrea === null && ($this->ind_usu_crea !== null)) {
			$this->aUsuarioRelatedByIndUsuCrea = UsuarioPeer::retrieveByPk($this->ind_usu_crea);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByIndUsuCrea->addIndicadorsRelatedByIndUsuCrea($this);
			 */
		}
		return $this->aUsuarioRelatedByIndUsuCrea;
	}
	 ...
	 * @throws     PropelException
	 */
	public function setUsuarioRelatedByIndUsuActualiza(Usuario $v = null)
	{
		if ($v === null) {
			$this->setIndUsuActualiza(NULL);
		} else {
			$this->setIndUsuActualiza($v->getUsuCodigo());
		}

		$this->aUsuarioRelatedByIndUsuActualiza = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Usuario object, it will not be re-added.
		if ($v !== null) {
			$v->addIndicadorRelatedByIndUsuActualiza($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getUsuarioRelatedByIndUsuActualiza(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByIndUsuActualiza === null && ($this->ind_usu_actualiza !== null)) {
			$this->aUsuarioRelatedByIndUsuActualiza = UsuarioPeer::retrieveByPk($this->ind_usu_actualiza);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByIndUsuActualiza->addIndicadorsRelatedByIndUsuActualiza($this);
			 */
		}
		return $this->aUsuarioRelatedByIndUsuActualiza;
	}
	 ...
	 * Otherwise if this Indicador has previously been saved, it will retrieve
	 * related MetaAnualXIndicadors from storage. If this Indicador is new, it will return
		...
		if ($this->collMetaAnualXIndicadors === null) {
			if ($this->isNew()) {
			   $this->collMetaAnualXIndicadors = array();
				...
				$criteria->add(MetaAnualXIndicadorPeer::MEA_IND_CODIGO, $this->ind_codigo);
	 ...
	 * Otherwise if this Indicador is new, it will return
	 * an empty collection; or if this Indicador has previously
	 * been saved, it will retrieve related MetaAnualXIndicadors from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Indicador.
	 */
	public function getMetaAnualXIndicadorsJoinEmpresa($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(IndicadorPeer::DATABASE_NAME);
		}
		...
		if ($this->collMetaAnualXIndicadors === null) {
			if ($this->isNew()) {
				...
				$this->collMetaAnualXIndicadors = MetaAnualXIndicadorPeer::doSelectJoinEmpresa($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
