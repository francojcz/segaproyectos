...
abstract class BaseMetodo extends BaseObject  implements Persistent {
	 ...
	 * @var        Usuario
	 */
	protected $aUsuarioRelatedByMetUsuCrea;

	/**
	 * @var        Usuario
	 */
	protected $aUsuarioRelatedByMetUsuActualiza;
	...
	public function setMetUsuCrea($v)
	{
		...
		if ($this->aUsuarioRelatedByMetUsuCrea !== null && $this->aUsuarioRelatedByMetUsuCrea->getUsuCodigo() !== $v) {
			$this->aUsuarioRelatedByMetUsuCrea = null;
		}
	...
	public function setMetUsuActualiza($v)
	{
		...
		if ($this->aUsuarioRelatedByMetUsuActualiza !== null && $this->aUsuarioRelatedByMetUsuActualiza->getUsuCodigo() !== $v) {
			$this->aUsuarioRelatedByMetUsuActualiza = null;
		}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aUsuarioRelatedByMetUsuCrea !== null && $this->met_usu_crea !== $this->aUsuarioRelatedByMetUsuCrea->getUsuCodigo()) {
			$this->aUsuarioRelatedByMetUsuCrea = null;
		}
		if ($this->aUsuarioRelatedByMetUsuActualiza !== null && $this->met_usu_actualiza !== $this->aUsuarioRelatedByMetUsuActualiza->getUsuCodigo()) {
			$this->aUsuarioRelatedByMetUsuActualiza = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aUsuarioRelatedByMetUsuCrea !== null) {
				if ($this->aUsuarioRelatedByMetUsuCrea->isModified() || $this->aUsuarioRelatedByMetUsuCrea->isNew()) {
					$affectedRows += $this->aUsuarioRelatedByMetUsuCrea->save($con);
				}
				$this->setUsuarioRelatedByMetUsuCrea($this->aUsuarioRelatedByMetUsuCrea);
			}

			if ($this->aUsuarioRelatedByMetUsuActualiza !== null) {
				if ($this->aUsuarioRelatedByMetUsuActualiza->isModified() || $this->aUsuarioRelatedByMetUsuActualiza->isNew()) {
					$affectedRows += $this->aUsuarioRelatedByMetUsuActualiza->save($con);
				}
				$this->setUsuarioRelatedByMetUsuActualiza($this->aUsuarioRelatedByMetUsuActualiza);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aUsuarioRelatedByMetUsuCrea !== null) {
				if (!$this->aUsuarioRelatedByMetUsuCrea->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsuarioRelatedByMetUsuCrea->getValidationFailures());
				}
			}

			if ($this->aUsuarioRelatedByMetUsuActualiza !== null) {
				if (!$this->aUsuarioRelatedByMetUsuActualiza->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsuarioRelatedByMetUsuActualiza->getValidationFailures());
				}
			}
	 ...
	 * @throws     PropelException
	 */
	public function setUsuarioRelatedByMetUsuCrea(Usuario $v = null)
	{
		if ($v === null) {
			$this->setMetUsuCrea(NULL);
		} else {
			$this->setMetUsuCrea($v->getUsuCodigo());
		}

		$this->aUsuarioRelatedByMetUsuCrea = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Usuario object, it will not be re-added.
		if ($v !== null) {
			$v->addMetodoRelatedByMetUsuCrea($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getUsuarioRelatedByMetUsuCrea(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByMetUsuCrea === null && ($this->met_usu_crea !== null)) {
			$this->aUsuarioRelatedByMetUsuCrea = UsuarioPeer::retrieveByPk($this->met_usu_crea);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByMetUsuCrea->addMetodosRelatedByMetUsuCrea($this);
			 */
		}
		return $this->aUsuarioRelatedByMetUsuCrea;
	}
	 ...
	 * @throws     PropelException
	 */
	public function setUsuarioRelatedByMetUsuActualiza(Usuario $v = null)
	{
		if ($v === null) {
			$this->setMetUsuActualiza(NULL);
		} else {
			$this->setMetUsuActualiza($v->getUsuCodigo());
		}

		$this->aUsuarioRelatedByMetUsuActualiza = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Usuario object, it will not be re-added.
		if ($v !== null) {
			$v->addMetodoRelatedByMetUsuActualiza($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getUsuarioRelatedByMetUsuActualiza(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByMetUsuActualiza === null && ($this->met_usu_actualiza !== null)) {
			$this->aUsuarioRelatedByMetUsuActualiza = UsuarioPeer::retrieveByPk($this->met_usu_actualiza);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByMetUsuActualiza->addMetodosRelatedByMetUsuActualiza($this);
			 */
		}
		return $this->aUsuarioRelatedByMetUsuActualiza;
	}
	 ...
	 * related RegistroUsoMaquinas from storage. If this Metodo is new, it will return
		...
		if ($this->collRegistroUsoMaquinas === null) {
			if ($this->isNew()) {
			   $this->collRegistroUsoMaquinas = array();
				...
				$criteria->add(RegistroUsoMaquinaPeer::RUM_MET_CODIGO, $this->met_codigo);
	 ...
	 */
	public function getRegistroUsoMaquinasJoinMaquina($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(MetodoPeer::DATABASE_NAME);
		}
		...
		if ($this->collRegistroUsoMaquinas === null) {
			if ($this->isNew()) {
				...
				$this->collRegistroUsoMaquinas = RegistroUsoMaquinaPeer::doSelectJoinMaquina($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
