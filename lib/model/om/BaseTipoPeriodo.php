...
abstract class BaseTipoPeriodo extends BaseObject  implements Persistent {
	 ...
	 * @var        Usuario
	 */
	protected $aUsuarioRelatedByTpUsuCrea;

	/**
	 * @var        Usuario
	 */
	protected $aUsuarioRelatedByTpUsuActualiza;

	/**
	 * @var        array PeriodoMantenimiento[] Collection to store aggregation of PeriodoMantenimiento objects.
	 */
	protected $collPeriodoMantenimientos;

	/**
	 * @var        Criteria The criteria used to select the current contents of collPeriodoMantenimientos.
	 */
	private $lastPeriodoMantenimientoCriteria = null;
	...
	public function setTpUsuCrea($v)
	{
		...
		if ($this->aUsuarioRelatedByTpUsuCrea !== null && $this->aUsuarioRelatedByTpUsuCrea->getUsuCodigo() !== $v) {
			$this->aUsuarioRelatedByTpUsuCrea = null;
		}
	...
	public function setTpUsuActualiza($v)
	{
		...
		if ($this->aUsuarioRelatedByTpUsuActualiza !== null && $this->aUsuarioRelatedByTpUsuActualiza->getUsuCodigo() !== $v) {
			$this->aUsuarioRelatedByTpUsuActualiza = null;
		}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aUsuarioRelatedByTpUsuCrea !== null && $this->tp_usu_crea !== $this->aUsuarioRelatedByTpUsuCrea->getUsuCodigo()) {
			$this->aUsuarioRelatedByTpUsuCrea = null;
		}
		if ($this->aUsuarioRelatedByTpUsuActualiza !== null && $this->tp_usu_actualiza !== $this->aUsuarioRelatedByTpUsuActualiza->getUsuCodigo()) {
			$this->aUsuarioRelatedByTpUsuActualiza = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->aUsuarioRelatedByTpUsuCrea = null;
			$this->aUsuarioRelatedByTpUsuActualiza = null;
			$this->collPeriodoMantenimientos = null;
			$this->lastPeriodoMantenimientoCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aUsuarioRelatedByTpUsuCrea !== null) {
				if ($this->aUsuarioRelatedByTpUsuCrea->isModified() || $this->aUsuarioRelatedByTpUsuCrea->isNew()) {
					$affectedRows += $this->aUsuarioRelatedByTpUsuCrea->save($con);
				}
				$this->setUsuarioRelatedByTpUsuCrea($this->aUsuarioRelatedByTpUsuCrea);
			}

			if ($this->aUsuarioRelatedByTpUsuActualiza !== null) {
				if ($this->aUsuarioRelatedByTpUsuActualiza->isModified() || $this->aUsuarioRelatedByTpUsuActualiza->isNew()) {
					$affectedRows += $this->aUsuarioRelatedByTpUsuActualiza->save($con);
				}
				$this->setUsuarioRelatedByTpUsuActualiza($this->aUsuarioRelatedByTpUsuActualiza);
			}
			...
			if ($this->collPeriodoMantenimientos !== null) {
				foreach ($this->collPeriodoMantenimientos as $referrerFK) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aUsuarioRelatedByTpUsuCrea !== null) {
				if (!$this->aUsuarioRelatedByTpUsuCrea->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsuarioRelatedByTpUsuCrea->getValidationFailures());
				}
			}

			if ($this->aUsuarioRelatedByTpUsuActualiza !== null) {
				if (!$this->aUsuarioRelatedByTpUsuActualiza->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsuarioRelatedByTpUsuActualiza->getValidationFailures());
				}
			}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getPeriodoMantenimientos() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addPeriodoMantenimiento($relObj->copy($deepCopy));
				}
			}
	 ...
	 * @throws     PropelException
	 */
	public function setUsuarioRelatedByTpUsuCrea(Usuario $v = null)
	{
		if ($v === null) {
			$this->setTpUsuCrea(NULL);
		} else {
			$this->setTpUsuCrea($v->getUsuCodigo());
		}

		$this->aUsuarioRelatedByTpUsuCrea = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Usuario object, it will not be re-added.
		if ($v !== null) {
			$v->addTipoPeriodoRelatedByTpUsuCrea($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getUsuarioRelatedByTpUsuCrea(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByTpUsuCrea === null && ($this->tp_usu_crea !== null)) {
			$this->aUsuarioRelatedByTpUsuCrea = UsuarioPeer::retrieveByPk($this->tp_usu_crea);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByTpUsuCrea->addTipoPeriodosRelatedByTpUsuCrea($this);
			 */
		}
		return $this->aUsuarioRelatedByTpUsuCrea;
	}
	 ...
	 * @throws     PropelException
	 */
	public function setUsuarioRelatedByTpUsuActualiza(Usuario $v = null)
	{
		if ($v === null) {
			$this->setTpUsuActualiza(NULL);
		} else {
			$this->setTpUsuActualiza($v->getUsuCodigo());
		}

		$this->aUsuarioRelatedByTpUsuActualiza = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Usuario object, it will not be re-added.
		if ($v !== null) {
			$v->addTipoPeriodoRelatedByTpUsuActualiza($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getUsuarioRelatedByTpUsuActualiza(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByTpUsuActualiza === null && ($this->tp_usu_actualiza !== null)) {
			$this->aUsuarioRelatedByTpUsuActualiza = UsuarioPeer::retrieveByPk($this->tp_usu_actualiza);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByTpUsuActualiza->addTipoPeriodosRelatedByTpUsuActualiza($this);
			 */
		}
		return $this->aUsuarioRelatedByTpUsuActualiza;
	}

	/**
	 * Clears out the collPeriodoMantenimientos collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addPeriodoMantenimientos()
	 */
	public function clearPeriodoMantenimientos()
	{
		$this->collPeriodoMantenimientos = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collPeriodoMantenimientos collection (array).
	 *
	 * By default this just sets the collPeriodoMantenimientos collection to an empty array (like clearcollPeriodoMantenimientos());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initPeriodoMantenimientos()
	{
		$this->collPeriodoMantenimientos = array();
	}
	 ...
	 * Otherwise if this TipoPeriodo has previously been saved, it will retrieve
	 * related PeriodoMantenimientos from storage. If this TipoPeriodo is new, it will return
	 ...
	 * @throws     PropelException
	 */
	public function getPeriodoMantenimientos($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TipoPeriodoPeer::DATABASE_NAME);
		}
		...
		if ($this->collPeriodoMantenimientos === null) {
			if ($this->isNew()) {
			   $this->collPeriodoMantenimientos = array();
				...
				$criteria->add(PeriodoMantenimientoPeer::PMTO_TIPO, $this->tp_codigo);

				PeriodoMantenimientoPeer::addSelectColumns($criteria);
				$this->collPeriodoMantenimientos = PeriodoMantenimientoPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				PeriodoMantenimientoPeer::addSelectColumns($criteria);
				if (!isset($this->lastPeriodoMantenimientoCriteria) || !$this->lastPeriodoMantenimientoCriteria->equals($criteria)) {
					$this->collPeriodoMantenimientos = PeriodoMantenimientoPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastPeriodoMantenimientoCriteria = $criteria;
		return $this->collPeriodoMantenimientos;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countPeriodoMantenimientos(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TipoPeriodoPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collPeriodoMantenimientos === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastPeriodoMantenimientoCriteria) || !$this->lastPeriodoMantenimientoCriteria->equals($criteria)) {
					...
					$count = count($this->collPeriodoMantenimientos);
				}
			} else {
				$count = count($this->collPeriodoMantenimientos);
			}
	 ...
	 * @throws     PropelException
	 */
	public function addPeriodoMantenimiento(PeriodoMantenimiento $l)
	{
		if ($this->collPeriodoMantenimientos === null) {
			$this->initPeriodoMantenimientos();
		}
		if (!in_array($l, $this->collPeriodoMantenimientos, true)) { // only add it if the **same** object is not already associated
			array_push($this->collPeriodoMantenimientos, $l);
			$l->setTipoPeriodo($this);
		}
	}
	 ...
	 * Otherwise if this TipoPeriodo is new, it will return
	 * an empty collection; or if this TipoPeriodo has previously
	 * been saved, it will retrieve related PeriodoMantenimientos from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in TipoPeriodo.
	 */
	public function getPeriodoMantenimientosJoinUsuarioRelatedByPmtoUsuCrea($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TipoPeriodoPeer::DATABASE_NAME);
		}
		...
		if ($this->collPeriodoMantenimientos === null) {
			if ($this->isNew()) {
				...
				$this->collPeriodoMantenimientos = PeriodoMantenimientoPeer::doSelectJoinUsuarioRelatedByPmtoUsuCrea($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in TipoPeriodo.
	 */
	public function getPeriodoMantenimientosJoinUsuarioRelatedByPmtoUsuActualiza($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TipoPeriodoPeer::DATABASE_NAME);
		}
		...
		if ($this->collPeriodoMantenimientos === null) {
			if ($this->isNew()) {
				...
				$this->collPeriodoMantenimientos = PeriodoMantenimientoPeer::doSelectJoinUsuarioRelatedByPmtoUsuActualiza($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	{
		if ($deep) {
			if ($this->collPeriodoMantenimientos) {
				foreach ((array) $this->collPeriodoMantenimientos as $o) {
