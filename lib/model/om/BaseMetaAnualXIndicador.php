...
abstract class BaseMetaAnualXIndicador extends BaseObject  implements Persistent {
	 ...
	 * @var        Usuario
	 */
	protected $aUsuarioRelatedByMeaUsuCrea;

	/**
	 * @var        Usuario
	 */
	protected $aUsuarioRelatedByMeaUsuActualiza;
	...
	public function setMeaIndCodigo($v)
	{
		...
		if ($this->aIndicador !== null && $this->aIndicador->getIndCodigo() !== $v) {
	...
	public function setMeaUsuCrea($v)
	{
		...
		if ($this->aUsuarioRelatedByMeaUsuCrea !== null && $this->aUsuarioRelatedByMeaUsuCrea->getUsuCodigo() !== $v) {
			$this->aUsuarioRelatedByMeaUsuCrea = null;
		}
	...
	public function setMeaUsuActualiza($v)
	{
		...
		if ($this->aUsuarioRelatedByMeaUsuActualiza !== null && $this->aUsuarioRelatedByMeaUsuActualiza->getUsuCodigo() !== $v) {
			$this->aUsuarioRelatedByMeaUsuActualiza = null;
		}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aIndicador !== null && $this->mea_ind_codigo !== $this->aIndicador->getIndCodigo()) {
			$this->aIndicador = null;
		}
		if ($this->aEmpresa !== null && $this->mea_emp_codigo !== $this->aEmpresa->getEmpCodigo()) {
			$this->aEmpresa = null;
		}
		if ($this->aUsuarioRelatedByMeaUsuCrea !== null && $this->mea_usu_crea !== $this->aUsuarioRelatedByMeaUsuCrea->getUsuCodigo()) {
			$this->aUsuarioRelatedByMeaUsuCrea = null;
		}
		if ($this->aUsuarioRelatedByMeaUsuActualiza !== null && $this->mea_usu_actualiza !== $this->aUsuarioRelatedByMeaUsuActualiza->getUsuCodigo()) {
			$this->aUsuarioRelatedByMeaUsuActualiza = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aIndicador !== null) {
				if ($this->aIndicador->isModified() || $this->aIndicador->isNew()) {
			...
			if ($this->aUsuarioRelatedByMeaUsuCrea !== null) {
				if ($this->aUsuarioRelatedByMeaUsuCrea->isModified() || $this->aUsuarioRelatedByMeaUsuCrea->isNew()) {
					$affectedRows += $this->aUsuarioRelatedByMeaUsuCrea->save($con);
				}
				$this->setUsuarioRelatedByMeaUsuCrea($this->aUsuarioRelatedByMeaUsuCrea);
			}

			if ($this->aUsuarioRelatedByMeaUsuActualiza !== null) {
				if ($this->aUsuarioRelatedByMeaUsuActualiza->isModified() || $this->aUsuarioRelatedByMeaUsuActualiza->isNew()) {
					$affectedRows += $this->aUsuarioRelatedByMeaUsuActualiza->save($con);
				}
				$this->setUsuarioRelatedByMeaUsuActualiza($this->aUsuarioRelatedByMeaUsuActualiza);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aUsuarioRelatedByMeaUsuCrea !== null) {
				if (!$this->aUsuarioRelatedByMeaUsuCrea->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsuarioRelatedByMeaUsuCrea->getValidationFailures());
				}
			}

			if ($this->aUsuarioRelatedByMeaUsuActualiza !== null) {
				if (!$this->aUsuarioRelatedByMeaUsuActualiza->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsuarioRelatedByMeaUsuActualiza->getValidationFailures());
				}
			}
	...
	/**
	 * Declares an association between this object and a Indicador object.
	 *
	 * @param      Indicador $v
	 * @return     MetaAnualXIndicador The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setIndicador(Indicador $v = null)
	{
		if ($v === null) {
			$this->setMeaIndCodigo(NULL);
		} else {
			$this->setMeaIndCodigo($v->getIndCodigo());
		}

		$this->aIndicador = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Indicador object, it will not be re-added.
		if ($v !== null) {
			$v->addMetaAnualXIndicador($this);
		}
	...
	/**
	 * Get the associated Indicador object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     Indicador The associated Indicador object.
	 * @throws     PropelException
	 */
	public function getIndicador(PropelPDO $con = null)
	{
		if ($this->aIndicador === null && ($this->mea_ind_codigo !== null)) {
			$this->aIndicador = IndicadorPeer::retrieveByPk($this->mea_ind_codigo);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aIndicador->addMetaAnualXIndicadors($this);
			 */
		}
	...
	{
		if ($v === null) {
			$this->setMeaEmpCodigo(NULL);
		} else {
			$this->setMeaEmpCodigo($v->getEmpCodigo());
		}
	...
	{
		if ($this->aEmpresa === null && ($this->mea_emp_codigo !== null)) {
			$this->aEmpresa = EmpresaPeer::retrieveByPk($this->mea_emp_codigo);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aEmpresa->addMetaAnualXIndicadors($this);
			 */
		}
	 ...
	 * @throws     PropelException
	 */
	public function setUsuarioRelatedByMeaUsuCrea(Usuario $v = null)
	{
		if ($v === null) {
			$this->setMeaUsuCrea(NULL);
		} else {
			$this->setMeaUsuCrea($v->getUsuCodigo());
		}

		$this->aUsuarioRelatedByMeaUsuCrea = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Usuario object, it will not be re-added.
		if ($v !== null) {
			$v->addMetaAnualXIndicadorRelatedByMeaUsuCrea($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getUsuarioRelatedByMeaUsuCrea(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByMeaUsuCrea === null && ($this->mea_usu_crea !== null)) {
			$this->aUsuarioRelatedByMeaUsuCrea = UsuarioPeer::retrieveByPk($this->mea_usu_crea);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByMeaUsuCrea->addMetaAnualXIndicadorsRelatedByMeaUsuCrea($this);
			 */
		}
		return $this->aUsuarioRelatedByMeaUsuCrea;
	}
	 ...
	 * @throws     PropelException
	 */
	public function setUsuarioRelatedByMeaUsuActualiza(Usuario $v = null)
	{
		if ($v === null) {
			$this->setMeaUsuActualiza(NULL);
		} else {
			$this->setMeaUsuActualiza($v->getUsuCodigo());
		}

		$this->aUsuarioRelatedByMeaUsuActualiza = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Usuario object, it will not be re-added.
		if ($v !== null) {
			$v->addMetaAnualXIndicadorRelatedByMeaUsuActualiza($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getUsuarioRelatedByMeaUsuActualiza(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByMeaUsuActualiza === null && ($this->mea_usu_actualiza !== null)) {
			$this->aUsuarioRelatedByMeaUsuActualiza = UsuarioPeer::retrieveByPk($this->mea_usu_actualiza);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByMeaUsuActualiza->addMetaAnualXIndicadorsRelatedByMeaUsuActualiza($this);
			 */
		}
		return $this->aUsuarioRelatedByMeaUsuActualiza;
	}
