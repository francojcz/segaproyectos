...
abstract class BaseCategoriaEvento extends BaseObject  implements Persistent {
	...
	public function setUsuarioRelatedByCatUsuCrea(Usuario $v = null)
	{
		...
		if ($v !== null) {
			$v->addCategoriaEventoRelatedByCatUsuCrea($this);
		}
	...
	public function getUsuarioRelatedByCatUsuCrea(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByCatUsuCrea === null && ($this->cat_usu_crea !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUsuarioRelatedByCatUsuCrea->addCategoriaEventosRelatedByCatUsuCrea($this);
			 */
		}
	...
	public function setUsuarioRelatedByCatUsuActualiza(Usuario $v = null)
	{
		...
		// If this object has already been added to the Usuario object, it will not be re-added.
		if ($v !== null) {
			$v->addCategoriaEventoRelatedByCatUsuActualiza($this);
		}
	...
	public function getUsuarioRelatedByCatUsuActualiza(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByCatUsuActualiza === null && ($this->cat_usu_actualiza !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByCatUsuActualiza->addCategoriaEventosRelatedByCatUsuActualiza($this);
			 */
		}
	 ...
	 * Otherwise if this CategoriaEvento has previously been saved, it will retrieve
	 * related EventoPorCategorias from storage. If this CategoriaEvento is new, it will return
		...
		if ($this->collEventoPorCategorias === null) {
			if ($this->isNew()) {
			   $this->collEventoPorCategorias = array();
				...
				$criteria->add(EventoPorCategoriaPeer::EVCA_CAT_CODIGO, $this->cat_codigo);
	 ...
	 * Otherwise if this CategoriaEvento is new, it will return
	 * an empty collection; or if this CategoriaEvento has previously
	 * been saved, it will retrieve related EventoPorCategorias from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in CategoriaEvento.
	 */
