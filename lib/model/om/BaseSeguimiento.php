...
abstract class BaseSeguimiento extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->seg_fecha = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->seg_estado = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->seg_observacion = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = SeguimientoPeer::NUM_COLUMNS - SeguimientoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[1] => $this->getSegFecha(),
			$keys[2] => $this->getSegEstado(),
			$keys[3] => $this->getSegObservacion(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setSegFecha($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setSegEstado($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setSegObservacion($arr[$keys[3]]);
	}
