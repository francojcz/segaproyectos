...
abstract class BaseMaquinaPeer {
	...
	public static function doCountJoinEstado(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(MaquinaPeer::MAQ_EST_CODIGO, EstadoPeer::EST_CODIGO, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related Computador table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinComputador(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(MaquinaPeer::MAQ_COM_CERTIFICADO, ComputadorPeer::COM_CERTIFICADO, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related UsuarioRelatedByMaqUsuCrea table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinUsuarioRelatedByMaqUsuCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(MaquinaPeer::MAQ_USU_CREA, UsuarioPeer::USU_CODIGO, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related UsuarioRelatedByMaqUsuActualiza table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinUsuarioRelatedByMaqUsuActualiza(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(MaquinaPeer::MAQ_USU_ACTUALIZA, UsuarioPeer::USU_CODIGO, $join_behavior);
	...
	public static function doCountJoinCategoriaEquipo(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(MaquinaPeer::MAQ_CAT_CODIGO, CategoriaEquipoPeer::CAT_CODIGO, $join_behavior);
	...
	/**
	 * Selects a collection of Maquina objects pre-filled with their Estado objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Maquina objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinEstado(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		MaquinaPeer::addSelectColumns($criteria);
		$startcol = (MaquinaPeer::NUM_COLUMNS - MaquinaPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = MaquinaPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = MaquinaPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				MaquinaPeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Maquina) to $obj2 (Estado)
				$obj2->addMaquina($obj1);
	...
	/**
	 * Selects a collection of Maquina objects pre-filled with their Computador objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Maquina objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinComputador(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = ComputadorPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = ComputadorPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					...
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					ComputadorPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
				
				// Add the $obj1 (Maquina) to $obj2 (Computador)
				$obj2->addMaquina($obj1);
	...
	/**
	 * Selects a collection of Maquina objects pre-filled with their Usuario objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Maquina objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUsuarioRelatedByMaqUsuCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Maquina) to $obj2 (Usuario)
				$obj2->addMaquinaRelatedByMaqUsuCrea($obj1);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUsuarioRelatedByMaqUsuActualiza(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Maquina) to $obj2 (Usuario)
				$obj2->addMaquinaRelatedByMaqUsuActualiza($obj1);
	...
	/**
	 * Selects a collection of Maquina objects pre-filled with their CategoriaEquipo objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Maquina objects.
	...
	public static function doSelectJoinCategoriaEquipo(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Maquina) to $obj2 (CategoriaEquipo)
				$obj2->addMaquina($obj1);
	...
	/**
	 * Selects a collection of Maquina objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		MaquinaPeer::addSelectColumns($criteria);
		$startcol2 = (MaquinaPeer::NUM_COLUMNS - MaquinaPeer::NUM_LAZY_LOAD_COLUMNS);

		EstadoPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (EstadoPeer::NUM_COLUMNS - EstadoPeer::NUM_LAZY_LOAD_COLUMNS);

		ComputadorPeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + (ComputadorPeer::NUM_COLUMNS - ComputadorPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		CategoriaEquipoPeer::addSelectColumns($criteria);
		$startcol7 = $startcol6 + (CategoriaEquipoPeer::NUM_COLUMNS - CategoriaEquipoPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Maquina) to the collection in $obj2 (Estado)
				$obj2->addMaquina($obj1);
			} // if joined row not null

			// Add objects for joined Computador rows

			$key3 = ComputadorPeer::getPrimaryKeyHashFromRow($row, $startcol3);
			if ($key3 !== null) {
				$obj3 = ComputadorPeer::getInstanceFromPool($key3);
				if (!$obj3) {
					...
					ComputadorPeer::addInstanceToPool($obj3, $key3);
				} // if obj3 loaded

				// Add the $obj1 (Maquina) to the collection in $obj3 (Computador)
				$obj3->addMaquina($obj1);
			} // if joined row not null
			...
			if ($key4 !== null) {
				...
				// Add the $obj1 (Maquina) to the collection in $obj4 (Usuario)
				$obj4->addMaquinaRelatedByMaqUsuCrea($obj1);
			} // if joined row not null
			...
			if ($key5 !== null) {
				...
				// Add the $obj1 (Maquina) to the collection in $obj5 (Usuario)
				$obj5->addMaquinaRelatedByMaqUsuActualiza($obj1);
			} // if joined row not null

			// Add objects for joined CategoriaEquipo rows

			$key6 = CategoriaEquipoPeer::getPrimaryKeyHashFromRow($row, $startcol6);
			if ($key6 !== null) {
				$obj6 = CategoriaEquipoPeer::getInstanceFromPool($key6);
				if (!$obj6) {
					...
					CategoriaEquipoPeer::addInstanceToPool($obj6, $key6);
				} // if obj6 loaded

				// Add the $obj1 (Maquina) to the collection in $obj6 (CategoriaEquipo)
				$obj6->addMaquina($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptComputador(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptUsuarioRelatedByMaqUsuCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptUsuarioRelatedByMaqUsuActualiza(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Maquina objects pre-filled with all related objects except Estado.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptEstado(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ComputadorPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (ComputadorPeer::NUM_COLUMNS - ComputadorPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		CategoriaEquipoPeer::addSelectColumns($criteria);
		$startcol6 = $startcol5 + (CategoriaEquipoPeer::NUM_COLUMNS - CategoriaEquipoPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = MaquinaPeer::getInstanceFromPool($key1))) {
				...
				$key2 = ComputadorPeer::getPrimaryKeyHashFromRow($row, $startcol2);
				if ($key2 !== null) {
					$obj2 = ComputadorPeer::getInstanceFromPool($key2);
					if (!$obj2) {
				...
				// Add the $obj1 (Maquina) to the collection in $obj2 (Computador)
				$obj2->addMaquina($obj1);
				...
				// Add the $obj1 (Maquina) to the collection in $obj3 (Usuario)
				$obj3->addMaquinaRelatedByMaqUsuCrea($obj1);
				...
				// Add the $obj1 (Maquina) to the collection in $obj4 (Usuario)
				$obj4->addMaquinaRelatedByMaqUsuActualiza($obj1);

			} // if joined row is not null

				// Add objects for joined CategoriaEquipo rows

				$key5 = CategoriaEquipoPeer::getPrimaryKeyHashFromRow($row, $startcol5);
				if ($key5 !== null) {
					$obj5 = CategoriaEquipoPeer::getInstanceFromPool($key5);
					if (!$obj5) {
					...
					$obj5 = new $cls();
					$obj5->hydrate($row, $startcol5);
					CategoriaEquipoPeer::addInstanceToPool($obj5, $key5);
				} // if $obj5 already loaded

				// Add the $obj1 (Maquina) to the collection in $obj5 (CategoriaEquipo)
				$obj5->addMaquina($obj1);
	...
	/**
	 * Selects a collection of Maquina objects pre-filled with all related objects except Computador.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptComputador(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Maquina objects pre-filled with all related objects except UsuarioRelatedByMaqUsuCrea.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUsuarioRelatedByMaqUsuCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = MaquinaPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Maquina) to the collection in $obj4 (CategoriaEquipo)
				$obj4->addMaquina($obj1);
	...
	/**
	 * Selects a collection of Maquina objects pre-filled with all related objects except UsuarioRelatedByMaqUsuActualiza.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUsuarioRelatedByMaqUsuActualiza(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Maquina objects pre-filled with all related objects except CategoriaEquipo.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
