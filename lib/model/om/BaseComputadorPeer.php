...
abstract class BaseComputadorPeer {
	...
	{
		// invalidate objects in MaquinaPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			ComputadorPeer::doOnDeleteSetNull(new Criteria(ComputadorPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			ComputadorPeer::doOnDeleteSetNull($criteria, $con);
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = ComputadorPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {

			// set fkey col in related Maquina rows to NULL
			$selectCriteria = new Criteria(ComputadorPeer::DATABASE_NAME);
			$updateValues = new Criteria(ComputadorPeer::DATABASE_NAME);
			$selectCriteria->add(MaquinaPeer::MAQ_COM_CERTIFICADO, $obj->getComCertificado());
			$updateValues->add(MaquinaPeer::MAQ_COM_CERTIFICADO, null);
