...
abstract class BaseRegistroPmtoMaquina extends BaseObject  implements Persistent {
	...
	/**
	 * @var        PeriodoMantenimiento
	 */
	protected $aPeriodoMantenimiento;
	...
	public function setRpmPmtoCodigo($v)
	{
		...
		if ($this->aPeriodoMantenimiento !== null && $this->aPeriodoMantenimiento->getPmtoCodigo() !== $v) {
			$this->aPeriodoMantenimiento = null;
		}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aMaquina !== null && $this->rpm_maq_codigo !== $this->aMaquina->getMaqCodigo()) {
			$this->aMaquina = null;
		}
		if ($this->aPeriodoMantenimiento !== null && $this->rpm_pmto_codigo !== $this->aPeriodoMantenimiento->getPmtoCodigo()) {
			$this->aPeriodoMantenimiento = null;
		}
		if ($this->aUsuario !== null && $this->rpm_usu_registra !== $this->aUsuario->getUsuCodigo()) {
			$this->aUsuario = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aPeriodoMantenimiento !== null) {
				if ($this->aPeriodoMantenimiento->isModified() || $this->aPeriodoMantenimiento->isNew()) {
					$affectedRows += $this->aPeriodoMantenimiento->save($con);
				}
				$this->setPeriodoMantenimiento($this->aPeriodoMantenimiento);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aPeriodoMantenimiento !== null) {
				if (!$this->aPeriodoMantenimiento->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aPeriodoMantenimiento->getValidationFailures());
				}
			}
	...
	{
		if ($v === null) {
			$this->setRpmMaqCodigo(NULL);
		} else {
			$this->setRpmMaqCodigo($v->getMaqCodigo());
		}
	...
	{
		if ($this->aMaquina === null && ($this->rpm_maq_codigo !== null)) {
			$this->aMaquina = MaquinaPeer::retrieveByPk($this->rpm_maq_codigo);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aMaquina->addRegistroPmtoMaquinas($this);
			 */
		}
	...
	/**
	 * Declares an association between this object and a PeriodoMantenimiento object.
	 *
	 * @param      PeriodoMantenimiento $v
	 * @return     RegistroPmtoMaquina The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setPeriodoMantenimiento(PeriodoMantenimiento $v = null)
	{
		if ($v === null) {
			$this->setRpmPmtoCodigo(NULL);
		} else {
			$this->setRpmPmtoCodigo($v->getPmtoCodigo());
		}

		$this->aPeriodoMantenimiento = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the PeriodoMantenimiento object, it will not be re-added.
		if ($v !== null) {
			$v->addRegistroPmtoMaquina($this);
		}
	...
	/**
	 * Get the associated PeriodoMantenimiento object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     PeriodoMantenimiento The associated PeriodoMantenimiento object.
	 * @throws     PropelException
	 */
	public function getPeriodoMantenimiento(PropelPDO $con = null)
	{
		if ($this->aPeriodoMantenimiento === null && ($this->rpm_pmto_codigo !== null)) {
			$this->aPeriodoMantenimiento = PeriodoMantenimientoPeer::retrieveByPk($this->rpm_pmto_codigo);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPeriodoMantenimiento->addRegistroPmtoMaquinas($this);
			 */
		}
		return $this->aPeriodoMantenimiento;
	}
	...
	{
		if ($v === null) {
			$this->setRpmUsuRegistra(NULL);
		} else {
			$this->setRpmUsuRegistra($v->getUsuCodigo());
		}
	...
	{
		if ($this->aUsuario === null && ($this->rpm_usu_registra !== null)) {
			$this->aUsuario = UsuarioPeer::retrieveByPk($this->rpm_usu_registra);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuario->addRegistroPmtoMaquinas($this);
			 */
		}
