...
abstract class BaseEmpleadoPeer {
	...
	public static function doCountJoinEmpresa(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EmpleadoPeer::EMPL_EMP_CODIGO, EmpresaPeer::EMP_CODIGO, $join_behavior);
	...
	public static function doCountJoinTipoIdentificacion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EmpleadoPeer::EMPL_TID_CODIGO, TipoIdentificacionPeer::TID_CODIGO, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related UsuarioRelatedByEmplUsuCodigo table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinUsuarioRelatedByEmplUsuCodigo(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(EmpleadoPeer::EMPL_USU_CODIGO, UsuarioPeer::USU_CODIGO, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related UsuarioRelatedByEmplUsuCrea table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinUsuarioRelatedByEmplUsuCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(EmpleadoPeer::EMPL_USU_CREA, UsuarioPeer::USU_CODIGO, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related UsuarioRelatedByEmplUsuActualiza table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinUsuarioRelatedByEmplUsuActualiza(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(EmpleadoPeer::EMPL_USU_ACTUALIZA, UsuarioPeer::USU_CODIGO, $join_behavior);
	...
	/**
	 * Selects a collection of Empleado objects pre-filled with their Empresa objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinEmpresa(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		EmpleadoPeer::addSelectColumns($criteria);
		$startcol = (EmpleadoPeer::NUM_COLUMNS - EmpleadoPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Empleado) to $obj2 (Empresa)
	...
	/**
	 * Selects a collection of Empleado objects pre-filled with their TipoIdentificacion objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Empleado objects.
	...
	public static function doSelectJoinTipoIdentificacion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Empleado) to $obj2 (TipoIdentificacion)
				$obj2->addEmpleado($obj1);
	...
	/**
	 * Selects a collection of Empleado objects pre-filled with their Usuario objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Empleado objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUsuarioRelatedByEmplUsuCodigo(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Empleado) to $obj2 (Usuario)
				$obj2->addEmpleadoRelatedByEmplUsuCodigo($obj1);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUsuarioRelatedByEmplUsuCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Empleado) to $obj2 (Usuario)
				$obj2->addEmpleadoRelatedByEmplUsuCrea($obj1);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUsuarioRelatedByEmplUsuActualiza(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Empleado) to $obj2 (Usuario)
				$obj2->addEmpleadoRelatedByEmplUsuActualiza($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		EmpleadoPeer::addSelectColumns($criteria);
		$startcol2 = (EmpleadoPeer::NUM_COLUMNS - EmpleadoPeer::NUM_LAZY_LOAD_COLUMNS);

		EmpresaPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (EmpresaPeer::NUM_COLUMNS - EmpresaPeer::NUM_LAZY_LOAD_COLUMNS);

		TipoIdentificacionPeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + (TipoIdentificacionPeer::NUM_COLUMNS - TipoIdentificacionPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Empleado) to the collection in $obj2 (Empresa)
				$obj2->addEmpleado($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Empleado) to the collection in $obj3 (TipoIdentificacion)
				$obj3->addEmpleado($obj1);
			} // if joined row not null
			...
			if ($key4 !== null) {
				...
				// Add the $obj1 (Empleado) to the collection in $obj4 (Usuario)
				$obj4->addEmpleadoRelatedByEmplUsuCodigo($obj1);
			} // if joined row not null
			...
			if ($key5 !== null) {
				...
				// Add the $obj1 (Empleado) to the collection in $obj5 (Usuario)
				$obj5->addEmpleadoRelatedByEmplUsuCrea($obj1);
			} // if joined row not null
			...
			if ($key6 !== null) {
				...
				// Add the $obj1 (Empleado) to the collection in $obj6 (Usuario)
				$obj6->addEmpleadoRelatedByEmplUsuActualiza($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptUsuarioRelatedByEmplUsuCodigo(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptUsuarioRelatedByEmplUsuCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptUsuarioRelatedByEmplUsuActualiza(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Empleado objects pre-filled with all related objects except Empresa.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptEmpresa(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = EmpleadoPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Empleado) to the collection in $obj2 (TipoIdentificacion)
				$obj2->addEmpleado($obj1);
				...
				// Add the $obj1 (Empleado) to the collection in $obj3 (Usuario)
				$obj3->addEmpleadoRelatedByEmplUsuCodigo($obj1);
				...
				// Add the $obj1 (Empleado) to the collection in $obj4 (Usuario)
				$obj4->addEmpleadoRelatedByEmplUsuCrea($obj1);
				...
				// Add the $obj1 (Empleado) to the collection in $obj5 (Usuario)
				$obj5->addEmpleadoRelatedByEmplUsuActualiza($obj1);
	...
	/**
	 * Selects a collection of Empleado objects pre-filled with all related objects except TipoIdentificacion.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Empleado objects pre-filled with all related objects except UsuarioRelatedByEmplUsuCodigo.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUsuarioRelatedByEmplUsuCodigo(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Empleado objects pre-filled with all related objects except UsuarioRelatedByEmplUsuCrea.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUsuarioRelatedByEmplUsuCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Empleado objects pre-filled with all related objects except UsuarioRelatedByEmplUsuActualiza.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUsuarioRelatedByEmplUsuActualiza(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
