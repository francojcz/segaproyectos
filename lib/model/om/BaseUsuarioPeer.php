...
abstract class BaseUsuarioPeer {
	...
	/** the column name for the USU_CONTRASENA field */
	...
	/** the column name for the USU_PERS_CODIGO field */
	const USU_PERS_CODIGO = 'usuario.USU_PERS_CODIGO';

	/** the column name for the USU_FECHA_REGISTRO field */
	const USU_FECHA_REGISTRO = 'usuario.USU_FECHA_REGISTRO';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UsuCodigo', 'UsuPerCodigo', 'UsuLogin', 'UsuContrasena', 'UsuHabilitado', 'UsuPersCodigo', 'UsuFechaRegistro', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('usuCodigo', 'usuPerCodigo', 'usuLogin', 'usuContrasena', 'usuHabilitado', 'usuPersCodigo', 'usuFechaRegistro', ),
		BasePeer::TYPE_COLNAME => array (self::USU_CODIGO, self::USU_PER_CODIGO, self::USU_LOGIN, self::USU_CONTRASENA, self::USU_HABILITADO, self::USU_PERS_CODIGO, self::USU_FECHA_REGISTRO, ),
		BasePeer::TYPE_FIELDNAME => array ('usu_codigo', 'usu_per_codigo', 'usu_login', 'usu_contrasena', 'usu_habilitado', 'usu_pers_codigo', 'usu_fecha_registro', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UsuCodigo' => 0, 'UsuPerCodigo' => 1, 'UsuLogin' => 2, 'UsuContrasena' => 3, 'UsuHabilitado' => 4, 'UsuPersCodigo' => 5, 'UsuFechaRegistro' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('usuCodigo' => 0, 'usuPerCodigo' => 1, 'usuLogin' => 2, 'usuContrasena' => 3, 'usuHabilitado' => 4, 'usuPersCodigo' => 5, 'usuFechaRegistro' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::USU_CODIGO => 0, self::USU_PER_CODIGO => 1, self::USU_LOGIN => 2, self::USU_CONTRASENA => 3, self::USU_HABILITADO => 4, self::USU_PERS_CODIGO => 5, self::USU_FECHA_REGISTRO => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('usu_codigo' => 0, 'usu_per_codigo' => 1, 'usu_login' => 2, 'usu_contrasena' => 3, 'usu_habilitado' => 4, 'usu_pers_codigo' => 5, 'usu_fecha_registro' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UsuarioPeer::USU_PERS_CODIGO);
		$criteria->addSelectColumn(UsuarioPeer::USU_FECHA_REGISTRO);
	}
