...
abstract class BaseUsuario extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the usu_contrasena field.
	 * @var        string
	 */
	...
	/**
	 * The value for the usu_pers_codigo field.
	 * @var        int
	 */
	protected $usu_pers_codigo;

	/**
	 * The value for the usu_fecha_registro field.
	 * @var        string
	 */
	protected $usu_fecha_registro;
	...
	/**
	 * Get the [usu_contrasena] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [usu_pers_codigo] column value.
	 * 
	 * @return     int
	 */
	public function getUsuPersCodigo()
	{
		return $this->usu_pers_codigo;
	}

	/**
	 * Get the [optionally formatted] temporal [usu_fecha_registro] column value.
	 * 
	 *
	 ...
	 */
	public function getUsuFechaRegistro($format = 'Y-m-d H:i:s')
	{
		if ($this->usu_fecha_registro === null) {
			return null;
		}


		if ($this->usu_fecha_registro === '0000-00-00 00:00:00') {
			// while technically this is not a default value of NULL,
			// this seems to be closest in meaning.
			return null;
		} else {
			try {
				$dt = new DateTime($this->usu_fecha_registro);
			} catch (Exception $x) {
				throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->usu_fecha_registro, true), $x);
			}
		}
	...
	/**
	 * Set the value of [usu_contrasena] column.
	 * 
	 * @param      string $v new value
	 * @return     Usuario The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [usu_pers_codigo] column.
	 * 
	 * @param      int $v new value
	 * @return     Usuario The current object (for fluent API support)
	 */
	public function setUsuPersCodigo($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->usu_pers_codigo !== $v) {
			$this->usu_pers_codigo = $v;
			$this->modifiedColumns[] = UsuarioPeer::USU_PERS_CODIGO;
		}
	...
	/**
	 * Sets the value of [usu_fecha_registro] column to a normalized version of the date/time value specified.
	 * 
	 * @param      mixed $v string, integer (timestamp), or DateTime value.  Empty string will
	 *						be treated as NULL for temporal objects.
	 * @return     Usuario The current object (for fluent API support)
	 */
	public function setUsuFechaRegistro($v)
	{
		...
		if ( $this->usu_fecha_registro !== null || $dt !== null ) {
			// (nested ifs are a little easier to read in this case)

			$currNorm = ($this->usu_fecha_registro !== null && $tmpDt = new DateTime($this->usu_fecha_registro)) ? $tmpDt->format('Y-m-d H:i:s') : null;
			$newNorm = ($dt !== null) ? $dt->format('Y-m-d H:i:s') : null;

			if ( ($currNorm !== $newNorm) // normalized values don't match 
					)
			{
				$this->usu_fecha_registro = ($dt ? $dt->format('Y-m-d H:i:s') : null);
				$this->modifiedColumns[] = UsuarioPeer::USU_FECHA_REGISTRO;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->usu_contrasena = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->usu_habilitado = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->usu_pers_codigo = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->usu_fecha_registro = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->resetModified();
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 4:
				...
				break;
			case 5:
				return $this->getUsuPersCodigo();
				break;
			case 6:
				return $this->getUsuFechaRegistro();
				break;
			default:
				return null;
				break;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[3] => $this->getUsuContrasena(),
			$keys[4] => $this->getUsuHabilitado(),
			$keys[5] => $this->getUsuPersCodigo(),
			$keys[6] => $this->getUsuFechaRegistro(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 4:
				...
				break;
			case 5:
				$this->setUsuPersCodigo($value);
				break;
			case 6:
				$this->setUsuFechaRegistro($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setUsuContrasena($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setUsuHabilitado($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setUsuPersCodigo($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setUsuFechaRegistro($arr[$keys[6]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UsuarioPeer::USU_PERS_CODIGO)) $criteria->add(UsuarioPeer::USU_PERS_CODIGO, $this->usu_pers_codigo);
		if ($this->isColumnModified(UsuarioPeer::USU_FECHA_REGISTRO)) $criteria->add(UsuarioPeer::USU_FECHA_REGISTRO, $this->usu_fecha_registro);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setUsuPersCodigo($this->usu_pers_codigo);

		$copyObj->setUsuFechaRegistro($this->usu_fecha_registro);
