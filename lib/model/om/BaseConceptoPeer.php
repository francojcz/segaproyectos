...
abstract class BaseConceptoPeer {
	...
	/** the column name for the CON_CODIGO field */
	const CON_CODIGO = 'concepto.CON_CODIGO';

	/** the column name for the CON_NOMBRE field */
	const CON_NOMBRE = 'concepto.CON_NOMBRE';

	/** the column name for the CON_FECHA_REGISTRO field */
	const CON_FECHA_REGISTRO = 'concepto.CON_FECHA_REGISTRO';

	/** the column name for the CON_USU_CODIGO field */
	const CON_USU_CODIGO = 'concepto.CON_USU_CODIGO';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ConCodigo', 'ConNombre', 'ConFechaRegistro', 'ConUsuCodigo', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('conCodigo', 'conNombre', 'conFechaRegistro', 'conUsuCodigo', ),
		BasePeer::TYPE_COLNAME => array (self::CON_CODIGO, self::CON_NOMBRE, self::CON_FECHA_REGISTRO, self::CON_USU_CODIGO, ),
		BasePeer::TYPE_FIELDNAME => array ('con_codigo', 'con_nombre', 'con_fecha_registro', 'con_usu_codigo', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ConCodigo' => 0, 'ConNombre' => 1, 'ConFechaRegistro' => 2, 'ConUsuCodigo' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('conCodigo' => 0, 'conNombre' => 1, 'conFechaRegistro' => 2, 'conUsuCodigo' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::CON_CODIGO => 0, self::CON_NOMBRE => 1, self::CON_FECHA_REGISTRO => 2, self::CON_USU_CODIGO => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('con_codigo' => 0, 'con_nombre' => 1, 'con_fecha_registro' => 2, 'con_usu_codigo' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		$criteria->addSelectColumn(ConceptoPeer::CON_CODIGO);
		$criteria->addSelectColumn(ConceptoPeer::CON_NOMBRE);
		$criteria->addSelectColumn(ConceptoPeer::CON_FECHA_REGISTRO);
		$criteria->addSelectColumn(ConceptoPeer::CON_USU_CODIGO);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseConceptoPeer', $criteria, $con);
		}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ConceptoPeer::getOMClass(false);
	...
	{
		return $withPrefix ? ConceptoPeer::CLASS_DEFAULT : ConceptoPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConceptoPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseConceptoPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(ConceptoPeer::CON_CODIGO) && $criteria->keyContainsValue(ConceptoPeer::CON_CODIGO) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ConceptoPeer::CON_CODIGO.')');
		}
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConceptoPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseConceptoPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConceptoPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseConceptoPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ConceptoPeer::CON_CODIGO);
			$selectCriteria->add(ConceptoPeer::CON_CODIGO, $criteria->remove(ConceptoPeer::CON_CODIGO), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseConceptoPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseConceptoPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ConceptoPeer::CON_CODIGO, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ConceptoPeer::CON_CODIGO, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ConceptoPeer::DATABASE_NAME);
			$criteria->add(ConceptoPeer::CON_CODIGO, $pks, Criteria::IN);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseConceptoPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
