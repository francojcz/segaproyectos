...
abstract class BaseRegistroUsoMaquina extends BaseObject  implements Persistent {
	 ...
	 * @var        Usuario
	 */
	protected $aUsuarioRelatedByRumUsuCodigo;

	/**
	 * @var        Usuario
	 */
	protected $aUsuarioRelatedByRumUsuCodigoElimino;
	...
	public function setRumMetCodigo($v)
	{
		...
		if ($this->aMetodo !== null && $this->aMetodo->getMetCodigo() !== $v) {
			$this->aMetodo = null;
		}
	...
	public function setRumUsuCodigo($v)
	{
		...
		if ($this->aUsuarioRelatedByRumUsuCodigo !== null && $this->aUsuarioRelatedByRumUsuCodigo->getUsuCodigo() !== $v) {
			$this->aUsuarioRelatedByRumUsuCodigo = null;
		}
	...
	public function setRumUsuCodigoElimino($v)
	{
		...
		if ($this->aUsuarioRelatedByRumUsuCodigoElimino !== null && $this->aUsuarioRelatedByRumUsuCodigoElimino->getUsuCodigo() !== $v) {
			$this->aUsuarioRelatedByRumUsuCodigoElimino = null;
		}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aMaquina !== null && $this->rum_maq_codigo !== $this->aMaquina->getMaqCodigo()) {
			$this->aMaquina = null;
		}
		if ($this->aMetodo !== null && $this->rum_met_codigo !== $this->aMetodo->getMetCodigo()) {
			$this->aMetodo = null;
		}
		if ($this->aUsuarioRelatedByRumUsuCodigo !== null && $this->rum_usu_codigo !== $this->aUsuarioRelatedByRumUsuCodigo->getUsuCodigo()) {
			$this->aUsuarioRelatedByRumUsuCodigo = null;
		}
		if ($this->aUsuarioRelatedByRumUsuCodigoElimino !== null && $this->rum_usu_codigo_elimino !== $this->aUsuarioRelatedByRumUsuCodigoElimino->getUsuCodigo()) {
			$this->aUsuarioRelatedByRumUsuCodigoElimino = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aUsuarioRelatedByRumUsuCodigo !== null) {
				if ($this->aUsuarioRelatedByRumUsuCodigo->isModified() || $this->aUsuarioRelatedByRumUsuCodigo->isNew()) {
					$affectedRows += $this->aUsuarioRelatedByRumUsuCodigo->save($con);
				}
				$this->setUsuarioRelatedByRumUsuCodigo($this->aUsuarioRelatedByRumUsuCodigo);
			}

			if ($this->aUsuarioRelatedByRumUsuCodigoElimino !== null) {
				if ($this->aUsuarioRelatedByRumUsuCodigoElimino->isModified() || $this->aUsuarioRelatedByRumUsuCodigoElimino->isNew()) {
					$affectedRows += $this->aUsuarioRelatedByRumUsuCodigoElimino->save($con);
				}
				$this->setUsuarioRelatedByRumUsuCodigoElimino($this->aUsuarioRelatedByRumUsuCodigoElimino);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aUsuarioRelatedByRumUsuCodigo !== null) {
				if (!$this->aUsuarioRelatedByRumUsuCodigo->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsuarioRelatedByRumUsuCodigo->getValidationFailures());
				}
			}

			if ($this->aUsuarioRelatedByRumUsuCodigoElimino !== null) {
				if (!$this->aUsuarioRelatedByRumUsuCodigoElimino->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsuarioRelatedByRumUsuCodigoElimino->getValidationFailures());
				}
			}
	...
	{
		if ($v === null) {
			$this->setRumMaqCodigo(NULL);
		} else {
			$this->setRumMaqCodigo($v->getMaqCodigo());
		}
	...
	{
		if ($this->aMaquina === null && ($this->rum_maq_codigo !== null)) {
			$this->aMaquina = MaquinaPeer::retrieveByPk($this->rum_maq_codigo);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aMaquina->addRegistroUsoMaquinas($this);
			 */
		}
	...
	{
		if ($v === null) {
			$this->setRumMetCodigo(NULL);
		} else {
			$this->setRumMetCodigo($v->getMetCodigo());
		}
	...
	{
		if ($this->aMetodo === null && ($this->rum_met_codigo !== null)) {
			$this->aMetodo = MetodoPeer::retrieveByPk($this->rum_met_codigo);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aMetodo->addRegistroUsoMaquinas($this);
			 */
		}
		return $this->aMetodo;
	}
	 ...
	 * @throws     PropelException
	 */
	public function setUsuarioRelatedByRumUsuCodigo(Usuario $v = null)
	{
		if ($v === null) {
			$this->setRumUsuCodigo(NULL);
		} else {
			$this->setRumUsuCodigo($v->getUsuCodigo());
		}

		$this->aUsuarioRelatedByRumUsuCodigo = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Usuario object, it will not be re-added.
		if ($v !== null) {
			$v->addRegistroUsoMaquinaRelatedByRumUsuCodigo($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getUsuarioRelatedByRumUsuCodigo(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByRumUsuCodigo === null && ($this->rum_usu_codigo !== null)) {
			$this->aUsuarioRelatedByRumUsuCodigo = UsuarioPeer::retrieveByPk($this->rum_usu_codigo);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByRumUsuCodigo->addRegistroUsoMaquinasRelatedByRumUsuCodigo($this);
			 */
		}
		return $this->aUsuarioRelatedByRumUsuCodigo;
	}
	 ...
	 * @throws     PropelException
	 */
	public function setUsuarioRelatedByRumUsuCodigoElimino(Usuario $v = null)
	{
		if ($v === null) {
			$this->setRumUsuCodigoElimino(NULL);
		} else {
			$this->setRumUsuCodigoElimino($v->getUsuCodigo());
		}

		$this->aUsuarioRelatedByRumUsuCodigoElimino = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Usuario object, it will not be re-added.
		if ($v !== null) {
			$v->addRegistroUsoMaquinaRelatedByRumUsuCodigoElimino($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getUsuarioRelatedByRumUsuCodigoElimino(PropelPDO $con = null)
	{
		if ($this->aUsuarioRelatedByRumUsuCodigoElimino === null && ($this->rum_usu_codigo_elimino !== null)) {
			$this->aUsuarioRelatedByRumUsuCodigoElimino = UsuarioPeer::retrieveByPk($this->rum_usu_codigo_elimino);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuarioRelatedByRumUsuCodigoElimino->addRegistroUsoMaquinasRelatedByRumUsuCodigoElimino($this);
			 */
		}
		return $this->aUsuarioRelatedByRumUsuCodigoElimino;
	}
	 ...
	 * Otherwise if this RegistroUsoMaquina has previously been saved, it will retrieve
	 * related EventoEnRegistros from storage. If this RegistroUsoMaquina is new, it will return
		...
		if ($this->collEventoEnRegistros === null) {
			if ($this->isNew()) {
			   $this->collEventoEnRegistros = array();
				...
				$criteria->add(EventoEnRegistroPeer::EVRG_RUM_CODIGO, $this->rum_codigo);
	 ...
	 * Otherwise if this RegistroUsoMaquina is new, it will return
	 * an empty collection; or if this RegistroUsoMaquina has previously
	 * been saved, it will retrieve related EventoEnRegistros from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in RegistroUsoMaquina.
	 */
	public function getEventoEnRegistrosJoinEvento($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(RegistroUsoMaquinaPeer::DATABASE_NAME);
		}
		...
		if ($this->collEventoEnRegistros === null) {
			if ($this->isNew()) {
				...
				$this->collEventoEnRegistros = EventoEnRegistroPeer::doSelectJoinEvento($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this RegistroUsoMaquina has previously been saved, it will retrieve
	 * related RegistroModificacions from storage. If this RegistroUsoMaquina is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collRegistroModificacions === null) {
			if ($this->isNew()) {
			   $this->collRegistroModificacions = array();
				...
				$criteria->add(RegistroModificacionPeer::REM_RUM_CODIGO, $this->rum_codigo);
	 ...
	 * actually need in RegistroUsoMaquina.
	 */
	public function getRegistroModificacionsJoinUsuario($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(RegistroUsoMaquinaPeer::DATABASE_NAME);
		}
		...
		if ($this->collRegistroModificacions === null) {
			if ($this->isNew()) {
				...
				$this->collRegistroModificacions = RegistroModificacionPeer::doSelectJoinUsuario($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
