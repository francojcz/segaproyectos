...
class UsuarioTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('USU_CONTRASENA', 'UsuContrasena', 'VARCHAR', false, 200, null);
		$this->addColumn('USU_HABILITADO', 'UsuHabilitado', 'SMALLINT', false, 6, null);
		$this->addColumn('USU_PERS_CODIGO', 'UsuPersCodigo', 'INTEGER', false, 11, null);
		$this->addColumn('USU_FECHA_REGISTRO', 'UsuFechaRegistro', 'TIMESTAMP', false, null, null);
		// validators
	} // initialize()
