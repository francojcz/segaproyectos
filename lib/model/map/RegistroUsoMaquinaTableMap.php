...
class RegistroUsoMaquinaTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('RUM_MAQ_CODIGO', 'RumMaqCodigo', 'INTEGER', 'maquina', 'MAQ_CODIGO', false, 11, null);
		$this->addForeignKey('RUM_MET_CODIGO', 'RumMetCodigo', 'INTEGER', 'metodo', 'MET_CODIGO', false, 11, null);
		$this->addForeignKey('RUM_USU_CODIGO', 'RumUsuCodigo', 'INTEGER', 'usuario', 'USU_CODIGO', false, 11, null);
		$this->addForeignKey('RUM_USU_CODIGO_ELIMINO', 'RumUsuCodigoElimino', 'INTEGER', 'usuario', 'USU_CODIGO', false, 11, null);
	...
	{
    $this->addRelation('Maquina', 'Maquina', RelationMap::MANY_TO_ONE, array('rum_maq_codigo' => 'maq_codigo', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Metodo', 'Metodo', RelationMap::MANY_TO_ONE, array('rum_met_codigo' => 'met_codigo', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('UsuarioRelatedByRumUsuCodigo', 'Usuario', RelationMap::MANY_TO_ONE, array('rum_usu_codigo' => 'usu_codigo', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('UsuarioRelatedByRumUsuCodigoElimino', 'Usuario', RelationMap::MANY_TO_ONE, array('rum_usu_codigo_elimino' => 'usu_codigo', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('EventoEnRegistro', 'EventoEnRegistro', RelationMap::ONE_TO_MANY, array('rum_codigo' => 'evrg_rum_codigo', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('RegistroModificacion', 'RegistroModificacion', RelationMap::ONE_TO_MANY, array('rum_codigo' => 'rem_rum_codigo', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
