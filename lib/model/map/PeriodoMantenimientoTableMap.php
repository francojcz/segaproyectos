...
class PeriodoMantenimientoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('PMTO_TIPO', 'PmtoTipo', 'INTEGER', 'tipo_periodo', 'TP_CODIGO', false, 11, null);
		$this->addColumn('PMTO_FECHA_REGISTRO_SISTEMA', 'PmtoFechaRegistroSistema', 'TIMESTAMP', false, null, null);
		$this->addForeignKey('PMTO_USU_CREA', 'PmtoUsuCrea', 'INTEGER', 'usuario', 'USU_CODIGO', false, 11, null);
		$this->addForeignKey('PMTO_USU_ACTUALIZA', 'PmtoUsuActualiza', 'INTEGER', 'usuario', 'USU_CODIGO', false, 11, null);
	...
	{
    $this->addRelation('TipoPeriodo', 'TipoPeriodo', RelationMap::MANY_TO_ONE, array('pmto_tipo' => 'tp_codigo', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('UsuarioRelatedByPmtoUsuCrea', 'Usuario', RelationMap::MANY_TO_ONE, array('pmto_usu_crea' => 'usu_codigo', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('UsuarioRelatedByPmtoUsuActualiza', 'Usuario', RelationMap::MANY_TO_ONE, array('pmto_usu_actualiza' => 'usu_codigo', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('RegistroPmtoMaquina', 'RegistroPmtoMaquina', RelationMap::ONE_TO_MANY, array('pmto_codigo' => 'rpm_pmto_codigo', ), 'SET NULL', 'SET NULL');
	} // buildRelations()
