...
class CategoriaEquipoTableMap extends TableMap {
    ...
    $this->addRelation('Maquina', 'Maquina', RelationMap::ONE_TO_MANY, array('cat_codigo' => 'maq_cat_codigo', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Repuesto', 'Repuesto', RelationMap::ONE_TO_MANY, array('cat_codigo' => 'rep_cat_codigo', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
