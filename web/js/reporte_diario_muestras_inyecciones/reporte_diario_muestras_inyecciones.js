Ext.onReady(function(){
    ...
    var datastore = new Ext.data.Store({
        proxy: new Ext.data.HttpProxy({
            url: getAbsoluteUrl('reporte_diario_muestras_inyecciones', 'listarReportePorMetodo'),
            method: 'POST'
        }),
        reader: new Ext.data.JsonReader({
            root: 'data',
    ...
    var columns = [{
        ...
        header: 'Numero<br>de<br>muestras',
        tooltip: 'Numero de muestras',
        width: 65,
        align: 'center',
        ...
        header: 'Numero<br>de<br>inyecciones',
        tooltip: 'Numero de inyecciones',
        width: 75,
        align: 'center',
        renderer: generarRenderer('#e1de98', '#000000')
    }, {
    ...
    var operarios_datastore = new Ext.data.Store({
        proxy: new Ext.data.HttpProxy({
            url: getAbsoluteUrl('reporte_diario_muestras_inyecciones', 'listarOperarios'),
            method: 'POST'
        }),
        reader: new Ext.data.JsonReader({
            root: 'data',
    ...
    var maquinas_datastore = new Ext.data.Store({
        proxy: new Ext.data.HttpProxy({
            url: getAbsoluteUrl('reporte_diario_muestras_inyecciones', 'listarMaquinas'),
            method: 'POST'
        }),
        reader: new Ext.data.JsonReader({
            root: 'data',
    ...
    var panelPrincipal = new Ext.FormPanel({
        renderTo: 'panel_principal_reporte_diario_muestras_inyecciones',
        border: true,
        frame: true,
        layout: 'form',
        items: [{
